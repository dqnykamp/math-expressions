...
class astToLatex {
  ...
  statement(tree) {
    ...
    if (typeof tree === 'symbol') {
      return this.single_statement(tree.description);
    }

    if(typeof tree === 'boolean') {
      return this.single_statement(tree.toString());
    }
  ...
  single_statement(tree) {
    ...
    if (typeof tree === 'symbol') {
      return this.expression(tree.description);
    }

    if(typeof tree === 'boolean') {
      return this.expression(tree.toString());
    }
  ...
  expression(tree) {
    ...
    if (typeof tree === 'symbol') {
      return this.term(tree.description);
    }

    if(typeof tree === 'boolean') {
      return this.term(tree.toString());
    }
  ...
  term(tree) {
    ...
    if (typeof tree === 'symbol') {
      return this.factor(tree.description);
    }

    if(typeof tree === 'boolean') {
      return this.factor(tree.toString());
    }
  ...
  factor(tree) {
    ...
    if (typeof tree === 'symbol') {
      return this.stringConvert(tree.description);
    }

    if(typeof tree === 'boolean') {
      return this.stringConvert(tree.toString());
    }
