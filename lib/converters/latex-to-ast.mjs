...
import * as defaults from './parser-defaults.mjs';
import ParseError from './error.mjs';
import Parser from './lexers/latex';
import {associate_all} from '../trees/associate.mjs';
...
export default function parse(input, context) {
